...
public class Jeu {
    ...
    private void creerCarte(List<Enigme> enigmes) {
        ...
        zones[0] = new Zone("le couloir", "room1.jpg" );
        zones[1] = new Zone("l'escalier", "room3.jpg" );
        zones[2] = new Zone("la grande salle", "room2.jpg" );
        zones[3] = new Zone("la salle à manger", "room4.jpg" );
        zones[4] = new Zone("musee", "couloir1b.jpg" );
